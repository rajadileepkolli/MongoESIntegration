...
public class ElasticSearchOperationsTests extends DigitalBridgeApplicationTests {
	...
	@Test
	public final void testTermFacetSearchWithFiltersApi()
		...
		this.mockMvc
				.perform(post("/restapi/assetwrapper/search/termFacetSearch")
						.content(objectMapper.registerModule(new JodaModule())
								.writeValueAsString(termFacetRequest))
	...
	private AggregationTermRequest getTermFacetRequest() {
		...
		aggregationTermRequest
				.setDateTermsFilters(Arrays.asList(facetDateRange, facetDateRange1));
